...
const WHISPERS = [
  ...
  { id: "w_listener", text: "One who stayed to listen could be made more, at Rite — show them what burns.",
    when: (c) => c.count("listener") >= 1 },
  { id: "w_emissary", text: "Something waits at the window to be regarded. Study it — carefully.",
    when: (c) => c.has("emissary_card") && !c.done("study_emissary") },
  { id: "w_vigil", text: "An idle devotee could keep a vigil. Open a working and set them to tend it.",
    when: (c) => c.aspectTotal("devotee") >= 1 },
